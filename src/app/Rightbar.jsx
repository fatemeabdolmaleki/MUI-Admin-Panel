  ...
  return (
    <Box flex={2} p={2} sx={{ display: { xs: 'none', sm: 'block' } }}>
      <Box position={'fixed'} width={300}>
        ...
        <AvatarGroup max={4} sx={{width:'100%', display:'flex',justifyContent:'start', marginBlock:'10px'}}>
        ...
        <ImageList cols={4} rowHeight={100} gap={2}>
          <ImageListItem sx={{width:'90px',height:'100px'}}>
            <img style={{width:'100%', height:'100%',borderRadius:'5px'}}
              src='/1.jpg'
              alt=''
            />
          </ImageListItem>
          <ImageListItem sx={{width:'90px',height:'100px',borderRadius:'5px'}}>
